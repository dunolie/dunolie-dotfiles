...
Irssi::settings_add_str("greeter", "evening_message", "➠ good evenening all Europeans, good whatever to everyone else. ;)");
Irssi::settings_add_str("greeter", "afternoon_message", "➠ good afternoon all Europeans, good whatever to everyone else. ;)");
Irssi::settings_add_str("greeter", "morning_message", "➠ good morning all Europeans, good whatever to everyone else. ;)");
Irssi::settings_add_str("greeter", "night_message", "➠ good night all Europeans, good whatever to everyone else. ;)");
